      ...
      >
        ...
        <div className="linktree-socials">
          ...
          <a href="https://twitch.tv/stefisthechef" target="_blank" rel="noopener noreferrer" className="linktree-social-icon" aria-label="Twitch">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M11.571 4.714h1.715v5.143H11.57V4.714zm4.715 0H18v5.143h-1.714V4.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0H6zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714v9.429z"/></svg>
          </a>
          <a href="https://soundcloud.com/stefan-todd-628273407" target="_blank" rel="noopener noreferrer" className="linktree-social-icon" aria-label="SoundCloud">
            <svg width="20" height="20" viewBox="0 0 291 256" fill="currentColor"><path d="M4.14 156.2c-1.24 0-2.28-.9-2.48-2.08L0 140.84l1.66-13.52c.2-1.16 1.24-2.04 2.48-2.04s2.3.88 2.5 2.04l2.1 13.52-2.1 13.28c-.2 1.18-1.26 2.08-2.5 2.08zm12.7 8.56c-1.28 0-2.36-.92-2.54-2.16l-2.72-21.76 2.72-22.36c.18-1.24 1.26-2.18 2.54-2.18 1.3 0 2.38.94 2.56 2.18l3.08 22.36-3.08 21.76c-.18 1.24-1.26 2.16-2.56 2.16zm12.96.6c-1.36 0-2.5-1.04-2.66-2.38l-2.44-22.14 2.44-22.86c.16-1.34 1.3-2.38 2.66-2.38 1.38 0 2.52 1.04 2.7 2.38l2.76 22.86-2.76 22.14c-.18 1.34-1.32 2.38-2.7 2.38zm13.08.28c-1.48 0-2.68-1.14-2.82-2.6l-2.2-22.2 2.2-24.24c.14-1.46 1.34-2.6 2.82-2.6 1.46 0 2.68 1.14 2.82 2.6l2.52 24.24-2.52 22.2c-.14 1.46-1.36 2.6-2.82 2.6zm13.14.1c-1.56 0-2.84-1.24-2.94-2.8l-1.98-22.1 1.98-25.18c.1-1.56 1.38-2.8 2.94-2.8 1.58 0 2.86 1.24 2.98 2.8l2.24 25.18-2.24 22.1c-.12 1.56-1.4 2.8-2.98 2.8zm13.22.06c-1.68 0-3.04-1.34-3.12-3l-1.74-21.96 1.74-26.08c.08-1.66 1.44-3 3.12-3 1.66 0 3.04 1.34 3.12 3l2 26.08-2 21.96c-.08 1.66-1.46 3-3.12 3zm13.3.1c-1.78 0-3.2-1.42-3.26-3.2l-1.52-21.86 1.52-27.5c.06-1.78 1.48-3.2 3.26-3.2 1.76 0 3.2 1.42 3.26 3.2l1.74 27.5-1.74 21.86c-.06 1.78-1.5 3.2-3.26 3.2zm13.36.2c-1.88 0-3.38-1.52-3.42-3.4l-1.28-22.06 1.28-27.7c.04-1.88 1.54-3.4 3.42-3.4 1.86 0 3.38 1.52 3.42 3.4l1.46 27.7-1.46 22.06c-.04 1.88-1.56 3.4-3.42 3.4zm13.44.06c-1.98 0-3.56-1.58-3.58-3.56l-1.06-22.26 1.06-27.56c.02-1.98 1.6-3.56 3.58-3.56 1.96 0 3.56 1.58 3.58 3.56l1.2 27.56-1.2 22.26c-.02 1.98-1.62 3.56-3.58 3.56zm13.52.02c-2.08 0-3.74-1.68-3.74-3.76l-.82-22.28.82-27.28c0-2.08 1.66-3.76 3.74-3.76 2.06 0 3.74 1.68 3.74 3.76l.94 27.28-.94 22.28c0 2.08-1.68 3.76-3.74 3.76zm49.94 1.32c-1.86 0-89.7 0-93.24-.08a4.62 4.62 0 0 1-4.44-4.58V68.96c0-1.98 1.24-3.72 3.1-4.4a99.7 99.7 0 0 1 35.58-6.56c55.14 0 99.9 44.76 99.9 99.9 0 5.4-.44 10.7-1.28 15.88a52.3 52.3 0 0 1 35.44-13.84c28.94 0 52.42 23.48 52.42 52.42s-23.48 52.42-52.42 52.42z"/></svg>
          </a>
        </div>
