      ...
      >
        ...
        <div className="linktree-socials">
          ...
          <a href="https://soundcloud.com/stefan-todd-628273407" target="_blank" rel="noopener noreferrer" className="linktree-social-icon" aria-label="SoundCloud">
            <svg width="22" height="22" viewBox="0 0 640 512" fill="currentColor"><path d="M111.4 256.3l5.8 65-5.8 68.3c-.3 2.5-2.2 4.4-4.4 4.4s-4.2-1.9-4.4-4.4l-5.1-68.3 5.1-65c.3-2.5 2.2-4.4 4.4-4.4 2.2 0 4.2 1.9 4.4 4.4zm21.4-45.6c-2.8 0-4.7 2.2-5 5l-5.1 105.3 5.1 68.3c.3 2.8 2.2 5 5 5 2.5 0 4.7-2.2 5-5l5.8-68.3-5.8-105.3c-.3-2.8-2.5-5-5-5zm25.3-24.2c-3.1 0-5.3 2.2-5.6 5.3l-4.4 129.8 4.4 67.5c.3 3.1 2.5 5.3 5.6 5.3 2.8 0 5.3-2.2 5.6-5.3l5-67.5-5-129.8c-.3-3.1-2.8-5.3-5.6-5.3zm25.4-9.7c-3.6 0-5.8 2.5-6.1 5.8l-4.2 139.7 4.2 66.9c.3 3.3 2.5 5.8 6.1 5.8 3.3 0 5.8-2.5 6.1-5.8l4.7-66.9-4.7-139.7c-.3-3.3-2.8-5.8-6.1-5.8zm25.3-6.4c-3.9 0-6.4 2.8-6.7 6.4L199 310.5l3.1 66.4c.3 3.6 2.8 6.4 6.7 6.4 3.6 0 6.4-2.8 6.7-6.4l3.6-66.4-3.6-133.7c-.3-3.6-3.1-6.4-6.7-6.4zm25.5 .3c-4.2 0-6.9 3.1-7.2 6.9l-3.1 132.8 3.1 65.6c.3 3.9 3.1 6.9 7.2 6.9 3.9 0 6.9-3.1 7.2-6.9l3.6-65.6-3.6-132.8c-.3-3.9-3.3-6.9-7.2-6.9zm25.3-14.4c-4.4 0-7.5 3.3-7.8 7.5l-2.8 147.2 2.8 64.7c.3 4.2 3.3 7.5 7.8 7.5 4.2 0 7.5-3.3 7.8-7.5l3.1-64.7-3.1-147.2c-.3-4.2-3.6-7.5-7.8-7.5zm25.5-6.1c-4.7 0-8.1 3.6-8.3 8.1L273 310.5l2.5 63.9c.3 4.7 3.6 8.1 8.3 8.1 4.7 0 8.1-3.6 8.3-8.1l2.8-63.9-2.8-153.3c-.3-4.4-3.6-8.1-8.3-8.1zm25.3-3.3c-5 0-8.6 3.9-8.9 8.6l-2.2 159.4 2.2 63.1c.3 5 3.9 8.6 8.9 8.6 5 0 8.6-3.9 8.9-8.6l2.5-63.1-2.5-159.4c-.3-4.7-3.9-8.6-8.9-8.6zm25.6-2.2c-5.3 0-9.2 3.9-9.4 9.2l-1.9 161.6 1.9 62.2c.3 5.3 4.2 9.2 9.4 9.2 5.3 0 9.2-3.9 9.4-9.2l2.2-62.2-2.2-161.6c-.3-5.3-4.2-9.2-9.4-9.2zm25.3 .3c-5.6 0-9.7 4.2-10 9.7l-1.7 151.9 1.7 61.7c.3 5.6 4.4 9.7 10 9.7s9.7-4.2 10-9.7l1.9-61.7-1.9-151.9c-.3-5.6-4.4-9.7-10-9.7zm68.6-48.9c-7.2-2.5-15-3.9-23.1-3.9-28.9 0-54.4 14.7-69.4 37.2-.8 1.4-1.1 3.1-1.1 4.7v192.8c0 3.6 2.5 6.7 5.8 7.5.8 .3 1.7 .3 2.5 .3H526c42.8 0 77.5-34.7 77.5-77.5s-34.7-77.8-77.5-77.8c-5.6 0-11.1 .6-16.4 1.7-8.3-47.5-50.2-83-100.2-83z"/></svg>
          </a>
        </div>
