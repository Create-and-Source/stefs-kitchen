      ...
      >
        ...
        <div className="linktree-socials">
          ...
          <a href="https://soundcloud.com/stefan-todd-628273407" target="_blank" rel="noopener noreferrer" className="linktree-social-icon" aria-label="SoundCloud">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="0" strokeLinecap="round" strokeLinejoin="round"><path fill="currentColor" d="M1 18V14m2 5V12m2 7V11m2 8V10m2 9V9m2 10V8m2 11V7m2 12V6h1.5a4.5 4.5 0 1 1 0 9H15V6"/></svg>
          </a>
        </div>
